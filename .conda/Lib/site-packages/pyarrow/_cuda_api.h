...
static int import_pyarrow___cuda(void) {
  ...
  if (!module) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_is_buffer", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_is_buffer, "int (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_is_cudabuffer", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_is_cudabuffer, "int (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_wrap_cudabuffer_base", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_wrap_cudabuffer_base, "PyObject *(std::shared_ptr< arrow::cuda::CudaBuffer>  const &, PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_wrap_cudabuffer", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_wrap_cudabuffer, "PyObject *(std::shared_ptr< arrow::cuda::CudaBuffer>  const &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_unwrap_cudabuffer", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_unwrap_cudabuffer, "std::shared_ptr< arrow::cuda::CudaBuffer>  (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_is_cudahostbuffer", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_is_cudahostbuffer, "int (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_wrap_cudahostbuffer", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_wrap_cudahostbuffer, "PyObject *(std::shared_ptr< arrow::cuda::CudaHostBuffer>  const &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_unwrap_cudahostbuffer", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_unwrap_cudahostbuffer, "std::shared_ptr< arrow::cuda::CudaHostBuffer>  (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_is_cudacontext", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_is_cudacontext, "int (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_wrap_cudacontext", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_wrap_cudacontext, "PyObject *(std::shared_ptr< arrow::cuda::CudaContext>  const &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_unwrap_cudacontext", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_unwrap_cudacontext, "std::shared_ptr< arrow::cuda::CudaContext>  (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_is_cudaipcmemhandle", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_is_cudaipcmemhandle, "int (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_wrap_cudaipcmemhandle", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_wrap_cudaipcmemhandle, "PyObject *(std::shared_ptr< arrow::cuda::CudaIpcMemHandle>  &)") < 0) goto bad;
  if (__Pyx_ImportFunction_3_1_2(module, "pyarrow_unwrap_cudaipcmemhandle", (void (**)(void))&__pyx_api_f_7pyarrow_5_cuda_pyarrow_unwrap_cudaipcmemhandle, "std::shared_ptr< arrow::cuda::CudaIpcMemHandle>  (PyObject *)") < 0) goto bad;
